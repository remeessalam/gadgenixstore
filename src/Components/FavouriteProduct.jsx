      ...
      <div className="wrapper">
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="w-full  text-white">
            <h1
              data-aos="fade-left"
              className="text-5xl font-bold mb-8 flex items-center gap-2"
            >
              Find Your Best Favourite
            </h1>

            <p data-aos="fade-left" className="text-lg mb-8 text-blue-400">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div
                data-aos="fade-left"
                className="flex space-x-2 text-white border border-primarytextcolor rounded-full p-4"
              >
